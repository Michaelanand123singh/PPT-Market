...
import VideoDialog from '../data/VideoDialog';

const Catalog = () => {
  // Initial presentations data from imported products
  const [presentations, setPresentations] = useState(products);
  ...
  const categories = ['All', 'Pitch Deck', 'Business', 'Proposal', 'Contract'];

  // Handle card click
  const handleCardClick = (presentation) => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 py-12 px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {[...Array(15)].map((_, i) => (
          <div 
            key={i} 
            className="absolute bg-blue-200/30 rounded-full animate-blob blur-xl"
            style={{
      ...
      <div className="container mx-auto relative z-10 max-w-7xl">
        ...
        <div className="mb-12 text-center">
          <h1 className="text-5xl font-extrabold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-900 animate-gradient-x">
            Presentation Catalog
          </h1>
          <p className="text-xl text-blue-800 max-w-2xl mx-auto opacity-80 animate-fade-in">
            ...
            <div className="p-6">
              ...
              <div className="mb-4">
                ...
                <input 
                  ...
                  className="w-full border border-blue-200 rounded p-2 focus:border-blue-500 text-blue-800"
                  min="0"
                />
              </div>
              ...
              <div className="mb-4">
                ...
                <select 
                  ...
                  className="w-full border border-blue-200 rounded p-2 text-blue-800 focus:border-blue-500"
                >
                ...
                <button 
                  ...
                  className="mt-2 w-full text-blue-600 hover:bg-blue-100 rounded p-2"
                >
              ...
              <button 
                ...
                className="w-full bg-gradient-to-r from-red-500 to-red-700 text-white p-2 rounded hover:from-red-600 hover:to-red-800"
              >
                Reset All Filters
              </button>
            </div>
          ...
          <div className="flex-grow">
            ...
            <div className="mb-8">
              <Input
                ...
                className="w-full bg-white/70 backdrop-blur-lg border-blue-200 focus:border-blue-500 shadow-lg"
              />
            </div>
            ...
            {filteredAndSortedPresentations.length > 0 ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8">
                {filteredAndSortedPresentations.map((presentation) => (
                  <div 
                    key={presentation.id}
                    className="transform transition-all duration-500 hover:-translate-y-4 hover:scale-105 hover:shadow-2xl"
                  >
                    <PresentationCard
                      ...
                      className="bg-white/80 backdrop-blur-lg border border-blue-100 rounded-2xl shadow-lg"
                    />
                  </div>
                ))}
              </div>
      ...
      <button 
        ...
        className="fixed bottom-6 right-6 md:hidden bg-gradient-to-r from-blue-500 to-blue-700 text-white p-4 rounded-full shadow-2xl z-50 animate-bounce"
      >
